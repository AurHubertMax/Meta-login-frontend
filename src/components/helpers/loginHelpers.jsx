...
// export const loadThreadsFacebookSDK = () => {
...
//                 window.FB.init({
//                     appId: process.env.REACT_APP_THREADS_APP_ID,
//                     cookie: true,
//                     xfbml: true,
//                     version: 'v23.0'
//                 });
...
// export const handleThreadsLogin = () => {
//     return new Promise((resolve, reject) => {
//         window.FB.login(
//             response => {
//                 if (response.authResponse) {
//                     console.log("FB login response:", response);
//                     api.post(`/auth/threads/callback`, {
...
//             },
//             {
//                 scope: 'threads_basic,threads_content_publish,threads_delete,public_profile,email,business_management',
//                 auth_type: 'rerequest'
//             },
//         );
//     })
